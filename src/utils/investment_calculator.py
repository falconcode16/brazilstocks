...
def calculate_investment_value(
    ...
    """
    Calculate the final value of an investment with compound interest and
    ...
    Args:
        ...
        compounding_frequency (int): Number of times interest compounds per
            year (default: 12 for monthly)
...
def investment_growth_schedule(
    ...
    Returns:
        pd.DataFrame: DataFrame with columns ['year', 'balance',
            'total_contributions', 'interest_earned']
    """
    periodic_rate = annual_interest_rate / compounding_frequency
    schedule = []
    ...
    for year in range(1, years + 1):
        ...
        for period in range(compounding_frequency):
            ...
            if period % (compounding_frequency // 12) == 0:
